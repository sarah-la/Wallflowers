...
void motiondetected(){
 ...
 if(counter==1) {
  ...
  fillpixelbypixel(tft.Color565(200, 0, 0));
  lcd.clear();
  lcd.setCursor(0,0);
lcd.print("  they say that ");
 lcd.setCursor(0,1);
 lcd.print("childhood trauma");
 delay(2000);
 lcd.setCursor(0,0);
lcd.print("alters ones DNA:");
lcd.setCursor(0,1);
lcd.print(" body and soul. ");
delay(2000);
 lcd.setCursor(0,0);
lcd.print("I want to cradle");
lcd.setCursor(0,1);
lcd.print(" my inner child ");
Serial.println("    parade    ");}  

else if(counter==2){
  fillpixelbypixel(tft.Color565(50, 0, 0));
  lcd.clear();
  lcd.setCursor(0,0);
lcd.print("act of violence:");
 lcd.setCursor(0,1);
 lcd.print("forever changed.");
 delay(2000);
 lcd.setCursor(0,0);
lcd.print(" to perpetrate  ");
lcd.setCursor(0,1);
lcd.print("a type of crime ");
delay(2000);
 lcd.setCursor(0,0);
lcd.print("The unthinkable ");
lcd.setCursor(0,1);
lcd.print("happens too much");
Serial.println("    response    ");  
  }


else if(counter==3){
  fillpixelbypixel(tft.Color565(250, 0, 0));
  lcd.clear();
  lcd.setCursor(0,0);
lcd.print("Be gentle to me.");
 lcd.setCursor(0,1);
 lcd.print(" my inner child ");
 delay(2000);
 lcd.setCursor(0,0);
lcd.print(" Embrace me for ");
lcd.setCursor(0,1);
lcd.print(" my human being ");
delay(2000);
 lcd.setCursor(0,0);
lcd.print(" I love my DNA: ");
lcd.setCursor(0,1);
lcd.print("permanently new "); 
Serial.println("    maleable.   "); 
  }
  
else if(counter==4){
  fillpixelbypixel(tft.Color565(40, 0, 0));
  lcd.clear();
  lcd.setCursor(0,0);
lcd.print("TPPP: a gene now");
 lcd.setCursor(0,1);
 lcd.print("in all my cells.");
 delay(2000);
 lcd.setCursor(0,0);
lcd.print(" Switched  'on' ");
lcd.setCursor(0,1);
lcd.print("causing disease.");
delay(2000);
 lcd.setCursor(0,0);
lcd.print("so unacceptable ");
lcd.setCursor(0,1);
lcd.print("I never give up."); 
  Serial.println("other like warriors");
  }

  
else if(counter==5){
  fillpixelbypixel(tft.Color565(150, 0, 0));
  lcd.clear();
   lcd.setCursor(0,0);
lcd.print("To kill another ");
 lcd.setCursor(0,1);
 lcd.print("     slowly     ");
 delay(2000);
 lcd.setCursor(0,0);
lcd.print("   is to kill   ");
lcd.setCursor(0,1);
lcd.print(" oneself slowly.");
delay(2000);
 lcd.setCursor(0,0);
lcd.print("Life is so short");
lcd.setCursor(0,1);
lcd.print(" Must be gentle."); 
Serial.println("places at home.");
  }

  
else if(counter==6){
  fillpixelbypixel(tft.Color565(30, 0, 0));
  lcd.clear();
   lcd.setCursor(0,0);
lcd.print(" Violent Cycles ");
 lcd.setCursor(0,1);
 lcd.print(" one generation ");
 delay(2000);
 lcd.setCursor(0,0);
lcd.print("to the next, and");
lcd.setCursor(0,1);
lcd.print("on and on and on");
delay(2000);
 lcd.setCursor(0,0);
lcd.print("It stops here,");
lcd.setCursor(0,1);
lcd.print("now.  It's over.");
Serial.println("   blahblah   ");}

  
else if(counter==7){
 
  fillpixelbypixel(tft.Color565(100, 0, 0));
  lcd.clear();
  lcd.setCursor(0,0);
lcd.print("TPPP in a new");
 lcd.setCursor(0,1);
 lcd.print("state  Weakening");
 delay(2000);
 lcd.setCursor(0,0);
lcd.print("an immune system");
lcd.setCursor(0,1);
lcd.print("I will fight and");
delay(2000);
 lcd.setCursor(0,0);
lcd.print(" I will survive ");
lcd.setCursor(0,1);
lcd.print(" oh yes I will. ");
