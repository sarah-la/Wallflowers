...
void motiondetected(){
 ...
 if(counter==1) {
  tft.fillCircle(64,64,30,RED);
  lcd.clear();
  lcd.setCursor(0,0);
lcd.print("..and me? Well..");
 lcd.setCursor(0,1);
 lcd.print("I was surviving.");
 delay(2000);
 lcd.setCursor(0,0);
lcd.print(" I ate food, I  ");
lcd.setCursor(0,1);
lcd.print(" slept in a bed ");
delay(2000);
 lcd.setCursor(0,0);
lcd.print("I had a place in");
lcd.setCursor(0,1);
lcd.print("   society...   ");
Serial.println("    parade    ");}  

else if(counter==2){
 tft.fillCircle(64,64,30,BLUE);
  lcd.clear();
  lcd.setCursor(0,0);
lcd.print(" I dont want to ");
 lcd.setCursor(0,1);
 lcd.print("cause people to ");
 delay(2000);
 lcd.setCursor(0,0);
lcd.print(" feel scared or ");
lcd.setCursor(0,1);
...
Serial.println("    response    ");  
  ...
  tft.fillCircle(64,64,30,GREEN);
  lcd.clear();
  lcd.setCursor(0,0);
lcd.print("I felt angry and");
 lcd.setCursor(0,1);
 lcd.print(" alienated and  ");
 delay(2000);
 lcd.setCursor(0,0);
lcd.print("  isolated and  ");
lcd.setCursor(0,1);
lcd.print("alone Very alone");
delay(2000);
 lcd.setCursor(0,0);
lcd.print(" I didn't feel  ");
lcd.setCursor(0,1);
lcd.print("able to express."); 
Serial.println("    maleable.   "); 
  }
  
else if(counter==4){
  tft.fillCircle(64,64,30,YELLOW);
  lcd.clear();
  lcd.setCursor(0,0);
lcd.print("  There was no  ");
 lcd.setCursor(0,1);
 lcd.print(" room, no words ");
 delay(2000);
 lcd.setCursor(0,0);
lcd.print("I was trying to ");
lcd.setCursor(0,1);
lcd.print("  get something ");
delay(2000);
 lcd.setCursor(0,0);
lcd.print(" from my mother.");
lcd.setCursor(0,1);
lcd.print(" I never did... "); 
  Serial.println("other like warriors");
  }

  
else if(counter==5){
  tft.fillCircle(64,64,30,CYAN);
  lcd.clear();
   lcd.setCursor(0,0);
lcd.print("I can say I wish");
 lcd.setCursor(0,1);
 lcd.print("things had been ");
 delay(2000);
 lcd.setCursor(0,0);
lcd.print("different.  Now,");
lcd.setCursor(0,1);
lcd.print("its time to move");
delay(2000);
 lcd.setCursor(0,0);
lcd.print("forward, building");
lcd.setCursor(0,1);
lcd.print(" on everything. "); 
Serial.println("places at home.");
  }

  
else if(counter==6){
  tft.fillCircle(64,64,30,MAGENTA);
  lcd.clear();
   lcd.setCursor(0,0);
lcd.print("I have counted &");
 lcd.setCursor(0,1);
 lcd.print("  recounted and ");
 delay(2000);
 lcd.setCursor(0,0);
lcd.print(" counted again, ");
lcd.setCursor(0,1);
lcd.print("times a million.");
delay(2000);
 lcd.setCursor(0,0);
lcd.print("I'm done. Moving");
lcd.setCursor(0,1);
lcd.print("on. Moving on...");
Serial.println("   blahblah   ");}

  
else if(counter==7){
 tft.fillCircle(64,64,30,WHITE);
  lcd.clear();
  lcd.setCursor(0,0);
lcd.print("Better for me to");
 lcd.setCursor(0,1);
 lcd.print("have the room & ");
 delay(2000);
 lcd.setCursor(0,0);
lcd.print(" role models to ");
lcd.setCursor(0,1);
lcd.print(" build a strong ");
delay(2000);
 lcd.setCursor(0,0);
lcd.print("identity, my own");
lcd.setCursor(0,1);
lcd.print("  truest self.  ");
