...
void fillpixelbypixel(uint16_t color) {
  for (uint8_t x=0; x < tft.width()/2; x++) {
    for (uint8_t y=0; y < tft.height()/2; y++) {
      if(y != ((tft.height()/2) - (tft.height()/5))) {
        if (x != ((tft.width()/2) - (tft.width()/20))) {
...
void motiondetected(){
 ...
 if(counter==1) {
  ...
  lcd.clear();
  lcd.setCursor(0,0);
lcd.print("I recall my lil ");
 lcd.setCursor(0,1);
 lcd.print("bro getting hit ");
 delay(2000);
 lcd.setCursor(0,0);
lcd.print("alot by my dad. ");
lcd.setCursor(0,1);
lcd.print("My dad punished ");
delay(2000);
 lcd.setCursor(0,0);
lcd.print("him alot and was");
lcd.setCursor(0,1);
lcd.print("upset with him. ");
Serial.println("    parade    ");}  
  ...
  lcd.clear();
  lcd.setCursor(0,0);
lcd.print("  So my father  ");
 lcd.setCursor(0,1);
 lcd.print(" didnt show him ");
 delay(2000);
 lcd.setCursor(0,0);
lcd.print("  intimacy or   ");
lcd.setCursor(0,1);
lcd.print(" gentleness, too");
delay(2000);
 lcd.setCursor(0,0);
lcd.print("much as I recall");
lcd.setCursor(0,1);
lcd.print("Now he has kids.");
Serial.println("    response    ");  
  ...
  lcd.clear();
  lcd.setCursor(0,0);
lcd.print("And he literally");
 lcd.setCursor(0,1);
 lcd.print("doesn't know how");
 delay(2000);
 lcd.setCursor(0,0);
lcd.print(" to be intimate ");
lcd.setCursor(0,1);
lcd.print("with himself, to");
delay(2000);
 lcd.setCursor(0,0);
lcd.print("express himself ");
lcd.setCursor(0,1);
...
Serial.println("    maleable.   "); 
  ...
  lcd.clear();
  lcd.setCursor(0,0);
lcd.print(" Or be in touch ");
 lcd.setCursor(0,1);
 lcd.print(" with emotions. ");
 delay(2000);
 lcd.setCursor(0,0);
lcd.print("His feelings and");
lcd.setCursor(0,1);
lcd.print("express them in ");
delay(2000);
 lcd.setCursor(0,0);
lcd.print("a safe way that ");
lcd.setCursor(0,1);
lcd.print(" values himself "); 
  ...
  lcd.clear();
   lcd.setCursor(0,0);
lcd.print(" I love him so  ");
 lcd.setCursor(0,1);
 lcd.print("much.  My heart ");
 delay(2000);
 lcd.setCursor(0,0);
lcd.print(" breaks for him.");
lcd.setCursor(0,1);
lcd.print(" I want him to  ");
delay(2000);
 lcd.setCursor(0,0);
lcd.print(" live his best, ");
lcd.setCursor(0,1);
lcd.print(" happiest life. "); 
Serial.println("places at home.");
  ...
  lcd.clear();
   lcd.setCursor(0,0);
lcd.print("My brother is so");
 lcd.setCursor(0,1);
 lcd.print("kind and gentle ");
 delay(2000);
 lcd.setCursor(0,0);
lcd.print("and intelligent,");
lcd.setCursor(0,1);
lcd.print("by nature.  The ");
delay(2000);
 lcd.setCursor(0,0);
lcd.print(" world has made ");
lcd.setCursor(0,1);
lcd.print(" him numb, hard.");
Serial.println("   blahblah   ");}

  
else if(counter==7){
  fillpixelbypixel(WHITE);
  lcd.clear();
  lcd.setCursor(0,0);
lcd.print(" Why is it that ");
 lcd.setCursor(0,1);
 lcd.print("the old eat the ");
 delay(2000);
 lcd.setCursor(0,0);
lcd.print("young? A wish & ");
lcd.setCursor(0,1);
lcd.print("  a promise to  ");
delay(2000);
 lcd.setCursor(0,0);
lcd.print("   strengthen   ");
lcd.setCursor(0,1);
lcd.print("things with him.");
