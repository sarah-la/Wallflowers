...
//  matrix.fillRect(1,1, 5,5, LED_GREEN);
//  matrix.writeDisplay(); 
//}
if(flag==1){
 matrix.clear();
 matrix.drawRect(8,8, 0,0, LED_RED);
  matrix.drawRect(6,6, 2,2, LED_YELLOW);
//  matrix.fillRect(4,4, 8,8, LED_GREEN);
// matrix.fillRect(1,1, 5,5, LED_YELLOW);
  matrix.writeDisplay(); 
}
  ...
  matrix.drawRect(2,2, 6,6, LED_YELLOW);
  matrix.fillRect(4,4, 4,4, LED_GREEN);
